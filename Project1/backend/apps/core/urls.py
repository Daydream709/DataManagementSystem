...
from .views import (
    ...
    QuestionBankPublicListView,
    QuestionBankPublicView,
...
urlpatterns = [
    ...
    path("question-bank/public", QuestionBankPublicListView.as_view()),
    ...
    path("question-bank/<str:item_id>/public", QuestionBankPublicView.as_view()),
